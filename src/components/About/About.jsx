    ...
    return (
        <div className="about-page-container">
            <div className="about-container">
                 ...
                 <br/>
                 We are a community working to <b>enable, empower</b> and <b>enlighten</b> those students across the country who don’t have access to right guidance and mentorship.
                 <br/><br/>
                ...
                <hr/><br/><br/>
                 ...
                 We believe that <b>intent</b>   and <b>  conviction</b>   is more important than power and system to fix something which isn’t right. 
                 ...
                 often can’t figure out, what to do and what not to.  <b>  Google Summer of Codes</b>  or <b>  ACM ICPC </b>  seems alien to them. 
                ...
                We believe that a generation exposed to more meaningful content is more likely to have a <b> healthy thought process.</b> We would be 
